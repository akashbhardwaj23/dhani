  ...
  return (
    <div className="max-w-xl w-full flex h-full md:items-center flex-col">
      <div className="mb-4 md:mb-8">
        <h1 className="text-xl md:text-4xl text-white font-semibold mb-2 tracking-normal flex md:justify-center">
          Create a Password
        </h1>
        <h2 className="text-[#969fa5] text-sm md:text-base font-medium tracking-normal">
      ...
      <div className="w-full flex flex-col mb-10 relative gap-1">
        ...
        <input
          type="text"
          id="email"
          className="px-4 py-3 mb-2 md:mb-6 bg-[#202127] rounded-lg text-white font-semibold focus:outline-none focus:outline-2 focus:outline-[#4b93f8]"
          placeholder="Email"
        ...
        {showPassword ? (
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-6 absolute right-3 top-[8rem] md:top-[9rem] hover:cursor-pointer"
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <button
          className="bg-white text-black px-4 py-3 text-base font-semibold hover:cursor-pointer rounded-xl mb-4 w-full disabled:bg-[#b7b7b9] md:w-1/2 tracking-tight"
          disabled={!isChecked}
